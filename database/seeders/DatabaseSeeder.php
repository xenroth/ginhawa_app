...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ([['key' => 'seo_title', 'value' => 'GINHAWA // Covenant Network'], ['key' => 'seo_description', 'value' => 'A member-led network for human preservation and community intelligence.'], ['key' => 'seo_keywords', 'value' => 'Ginhawa, community, preservation, covenant'], ['key' => 'site_name', 'value' => 'GINHAWA']] as $setting) \App\Models\SiteSetting::create($setting);
    }
}