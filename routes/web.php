...
Route::get('/members/search', [ProfileController::class, 'searchMembers'])->middleware('auth')->name('members.search');
Route::get('/members/{user}', [ProfileController::class, 'show'])->middleware('auth')->name('members.profile');
Route::get('/profile/media/{type}', [ProfileController::class, 'media'])->middleware('auth')->name('profile.media');
Route::get('/members/{user}/media/{type}', [ProfileController::class, 'memberMedia'])->middleware('auth')->name('members.media');
Route::patch('/profile', [ProfileController::class, 'update'])->middleware('auth')->name('profile.update');
Route::patch('/profile/password', [ProfileController::class, 'changePassword'])->middleware('auth')->name('profile.password');
...
Route::delete('/admin/sectors/{sector}', [AdminController::class, 'destroySector'])->middleware(['auth', 'role:administrator'])->name('admin.sectors.destroy');
...
Route::delete('/admin/directives/{directive}', [AdminController::class, 'destroyDirective'])->middleware(['auth', 'role:administrator'])->name('admin.directives.destroy');
